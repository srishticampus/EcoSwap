...
function RequestsBorrow() {
      const [borrowItems, setBorrowItems] = useState(initialBorrowItems);
    
  return (
    <div className=" mt-24 p-6 rounded-lg shadow-md max-w-4xl mx-auto my-10">
      <h2 className="text-2xl font-bold mb-6">Borrow Request</h2>
