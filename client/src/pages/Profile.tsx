...
import { Settings, Package, Star, MessageCircle } from 'lucide-react';
          ...
          <div className="px-6 py-4">
            <div className="flex flex-col md:flex-row items-center">
              <img
                ...
                alt="Profile"
                className="w-32 h-32 rounde

d-full border-4 border-white -mt-16"
              />
              <div className="md:ml-6 text-center md:text-left mt-4 md:mt-0">
                <h1 className="text-2xl font-bold">John Doe</h1>
                <p className="text-gray-600">Eco Enthusiast | New York, NY</p>
